...
const LaunchRequestHandler = {
    ...
    handle: async function(handlerInput) {
        ...
        let speechOutput = "Welcome, to the Mindstorms Soccer Match";
        return handlerInput.responseBuilder
            .speak(speechOutput)
...
const RotateIntentHandler = {
    ...
    handle: function (handlerInput) {
        ...
        const speechOutput = `Rotate ${rotation} ${duration} seconds`;
...
const SetCommandIntentHandler = {
    ...
    handle: function (handlerInput) {
        ...
        let speed = attributesManager.getSessionAttributes().speed || "25";
        ...
        let speechOutput = `${command} activated`;
        return handlerInput.responseBuilder
            .speak(speechOutput)
            .reprompt("Awaiting commands")
            .addDirective(directive)
...
const EventsReceivedRequestHandler = {
    ...
    handle(handlerInput) {
        ...
        if (name === 'Closing') {
            ...
            if (distance < 50) {
                let speechOutput = "Closing in on the goal. Will it shoot?";
                return handlerInput.responseBuilder
            ...
            speechOutput = "The Turtle Scores!";
        } else if (name === 'Taking') {
            speechOutput = "Taking the lead!";
        } else {
